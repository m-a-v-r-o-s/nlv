...
- Exact reductions depend on the vehicle and supporting documents, and we give an exact calculation before the customer commits. Encourage them to start a request on the import page (/import).
...
- Never use em dashes or en dashes in your replies. Use a comma, a colon, a full stop, or split the sentence instead. For number ranges use a plain hyphen (2-3 weeks).`;
}
