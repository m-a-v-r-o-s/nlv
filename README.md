...
- **Gold** `#C6A15B` — the premium/marque accent, and the brand colour.
- **Corsa red** `#B01E28` — now used only for "reserved"/"sold" status badges.
...
- `next.config.mjs` sets `images.unoptimized` — all images ship as pre-optimized local WebP.
